...
//void disp_str24(char*, int, int, unsigned long);
//void disp_str32(char*, int, int, unsigned long);
...
//int disp_chr24(char, int, int, unsigned long);
//int disp_chr32(char, int, int, unsigned long);
